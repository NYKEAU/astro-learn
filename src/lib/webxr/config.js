...
export const WEBXR_CONFIG = {
    ...
    errors: {
        fr: {
            ...
            arNotSupported: "La réalité augmentée n'est pas supportée sur cet appareil",
    ...
    instructions: {
        fr: {
            ...
            tapToPlace: "Pointez votre caméra vers une surface plane et tapez pour placer le modèle",
        ...
        en: {
            ...
            tapToPlace: "Point your camera at a flat surface and tap to place the model",
...
export function getErrorMessage(errorKey, language = 'fr') {
    return WEBXR_CONFIG.errors[language]?.[errorKey] ||
...
export function getInstruction(instructionKey, language = 'fr') {
    return WEBXR_CONFIG.instructions[language]?.[instructionKey] ||
